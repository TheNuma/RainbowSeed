...
public class Combiner {
	...
	public static void combineItems(DraggableItem item1, DraggableItem item2) {
		if (interactions.hasCombinations(item1.getType(), item2.getType())) {
			...
			if (type3 == ItemType.ROSE || type3 == ItemType.DAFFODIL || type3 == ItemType.GREENBEANS || type3 == ItemType.BLUEBERRY ||
					type3 == ItemType.ORANGE_TREE || type3 == ItemType.INDIGO || type3 == ItemType.VIOLET) {
				RainbowAudioManager.playColorComboSound();
			} else {
